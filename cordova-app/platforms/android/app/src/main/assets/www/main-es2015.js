...
let CheckOutComponent = class CheckOutComponent {
    constructor(ordersService, usersService, tablesService, reciptsService, route) {
    ...
    ngOnInit() {
        ...
        this.ordersService.getOrders("kitchen", `?tableCode=${this.tableCode}`).subscribe((res) => this.kitchenOrders = res, (err) => console.log(err), () => {
            ...
            this.ordersService.getOrders("bar", `?tableCode=${this.tableCode}`).subscribe((res) => this.barOrders = res, (err) => console.log(err), () => {
    ...
    checkOut() {
        this.ordersService.checkOut("bar", this.tableCode).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
        this.ordersService.checkOut("kitchen", this.tableCode).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
        this.reciptsService.newRecipt(this.recipt).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
        this.usersService.user.jobs += 1;
        this.usersService.updateUser(this.usersService.user.username).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
        this.tablesService.updateTable(this.tableCode, { clients: 0 }).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
    }
};
...
let HomeComponent = class HomeComponent {
    constructor(menuService, tableService) {
    ...
    newTable() {
        let table = new src_models_table__WEBPACK_IMPORTED_MODULE_2__["Table"](this.tableCode, this.seats);
        this.tableService.newTable(table).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
    }
    newMenuItem() {
        let menuItem = new src_models_menuItem__WEBPACK_IMPORTED_MODULE_3__["MenuItem"](this.name, this.type, this.price, this.time);
        this.menuService.newMenuItem(menuItem).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
    }
    getMenu() {
        this.menuService.getMenu().subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
    }
};
...
let NavbarComponent = class NavbarComponent {
    ...
    ngOnInit() {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_3__('.container').click(() => {
            if (this.open) {
...
let OrderComponent = class OrderComponent {
    constructor(location, route, menuService, usersService, ordersService) {
    ...
    ngOnInit() {
        ...
        this.clients = +(this.route.snapshot.paramMap.get('clients'));
        this.tableCode = this.route.snapshot.paramMap.get('tableCode');
        this.menuService.getMenu('?type=first-dish').subscribe((res) => { this.firstDishes = res; }, (err) => console.log(err), () => { console.log("done"); });
        this.menuService.getMenu('?type=second-dish').subscribe((res) => { this.secondDishes = res; }, (err) => console.log(err), () => console.log("done"));
    ...
    sendOrder() {
        ...
        if (kitchenItems.length > 0) {
            ...
            this.ordersService.sendOrder("kitchen", kitchenOrder).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
        }
        if (barItems.length > 0) {
            ...
            this.ordersService.sendOrder("bar", barOrder).subscribe((res) => console.log(res), (err) => console.log(err), () => console.log("done"));
        }
        this.location.back();
    }
    goBack() {
...
let OrdersComponent = class OrdersComponent {
    ...
    getOrders() {
        this.ordersService.getOrders(this.where, "?status=ongoing").subscribe((res) => this.orders = res, (err) => {
            console.log(err);
...
let SignUpComponent = class SignUpComponent {
    ...
    submit() {
        this.usersService.signUp(this.user).subscribe((res) => {
...
let StaffComponent = class StaffComponent {
    ...
    getWaiters() {
        this.usersService.getUsers('?role=Cameriere').subscribe((res) => this.waiters = res, (err) => console.log(err), () => {
    ...
    getChefs() {
        this.usersService.getUsers('?role=Cuoco').subscribe((res) => this.chefs = res, (err) => console.log(err), () => {
    ...
    getBarMans() {
        this.usersService.getUsers('?role=Barista').subscribe((res) => this.barMans = res, (err) => console.log(err), () => {
    ...
    getDesks() {
        this.usersService.getUsers('?role=Cassa').subscribe((res) => this.desks = res, (err) => console.log(err), () => {
    ...
    deleteUser(user) {
        this.usersService.deleteUser(user).subscribe((res) => console.log(res), (err) => console.log(err), () => {
            ;
        });
    }
};
...
let StatisticsComponent = class StatisticsComponent {
    constructor(reciptsService, ordersService) {
        this.reciptsService = reciptsService;
        this.ordersService = ordersService;
        this.stats = [];
        this.statsRecipts = [];
    ...
    getKitchenOrders(date) {
        this.ordersService.getOrders("kitchen", '?date=' + date).subscribe((res) => this.ordersKitchen = res, (err) => console.log(err), () => {
    ...
    getBarOrders(date) {
        this.ordersService.getOrders("bar", '?date=' + date).subscribe((res) => this.ordersBar = res, (err) => console.log(err), () => {
    ...
    getRecipts(date) {
        this.reciptsService.getRecipts("?").subscribe((res) => this.recipts = res, (err) => console.log(err), () => {
            console.log("wqwqq");
...
class MenuItem {
    constructor(name, type, price, time) {
        this.name = name;
        this.type = type;
        this.price = price;
        this.time = time;
