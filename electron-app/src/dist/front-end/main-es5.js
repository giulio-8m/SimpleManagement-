...
var OrdersComponent = /** @class */ (function () {
    function OrdersComponent(location, ordersService, usersService) {
        this.location = location;
        this.ordersService = ordersService;
        this.usersService = usersService;
    }
    OrdersComponent.prototype.ngOnInit = function () {
        ...
        this.ordersService.getOrders(this.where, "?status=ongoing").subscribe(function (res) { return _this.orders = res; }, function (err) { return console.log(err); }, function () { return console.log("done"); });
    };
...
var SignInComponent = /** @class */ (function () {
    ...
    SignInComponent.prototype.submit = function () {
        var _this = this;
        this.usersService.signIn(this.user).subscribe(function (res) {
            localStorage.setItem('user_token', res);
            _this.usersService.parseToken(res);
        }, function (error) {
...
var StatisticsComponent = /** @class */ (function () {
    ...
    StatisticsComponent.prototype.initChartOrders = function () {
    ...
    StatisticsComponent.prototype.initChartRecipts = function () {
...
var TablesComponent = /** @class */ (function () {
    function TablesComponent(usersService, socketService, tablesService, router) {
        this.usersService = usersService;
    ...
    TablesComponent.prototype.isDesk = function () {
        return this.usersService.user.role == "Cassa";
    };
    TablesComponent.prototype.checkOut = function (event, table) {
...
var HeadersService = /** @class */ (function () {
    function HeadersService( /*token*/) {
    }
    HeadersService.prototype.intercept = function (request, next) {
...
var ReciptsService = /** @class */ (function () {
    function ReciptsService(http) {
        this.http = http;
    }
...
var Order = /** @class */ (function () {
    function Order(tableCode, waiter, clients, items) {
        this._id = null;
...
var Recipt = /** @class */ (function () {
    function Recipt(tableCode, clients) {
        this._id = null;
        var dateS = new Date();
        this.date = dateS.getDate() + '/' + dateS.getMonth() + '/' + dateS.getFullYear();
        this.tableCode = tableCode;
    ...
    Recipt.ctorParameters = function () { return [
        { type: String },
        { type: Number }
    ]; };
    return Recipt;
