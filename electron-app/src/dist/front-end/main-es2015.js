...
let OrdersComponent = class OrdersComponent {
    constructor(location, ordersService, usersService) {
        this.location = location;
        this.ordersService = ordersService;
        this.usersService = usersService;
    }
    ngOnInit() {
        ...
        this.ordersService.getOrders(this.where, "?status=ongoing").subscribe((res) => this.orders = res, (err) => console.log(err), () => console.log("done"));
    }
    ngAfterViewChecked() {
        if (this.orders)
